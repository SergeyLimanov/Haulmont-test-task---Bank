...
public class OfferOfCreditController {
    ...
    @Autowired
    public OfferOfCreditController(ClientServiceInterface clientServiceInterface, BankServiceInterface bankServiceInterface, OfferOfCreditInterface offerOfCreditInterface, CalculationPaymentServiceInterface calculationPaymentServiceInterface) {
    ...
    public String showNewCreditOfferForm(@PathVariable("clientId") UUID clientId, Model model) {
        ...
        model.addAttribute("creditOffer", OfferOfCredit.builder().client(client)
